...
-- purchase
-- \i api/purchase/add_allocations_to_purchase.sql
-- \i api/purchase/allocations_prices_options.sql
-- \i api/purchase/approve_allocations.sql
-- \i api/purchase/create_allocation.sql
-- \i api/purchase/create_purchase.sql
-- \i api/purchase/delete_allocations.sql
-- \i api/purchase/delete_purchase.sql
