...
create table supply_prices (
  supply_price_id integer primary key generated by default as identity,
...
create table costs (
  cost_id integer primary key generated by default as identity,
...
create table cost_prices (
  cost_price_id integer primary key generated by default as identity,
...
create table billing_costs (
  billing_cost_id integer primary key generated by default as identity,
  billing_id integer not null references billings (billing_id),
