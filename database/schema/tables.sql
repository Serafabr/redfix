...
create table depots (
  ...
  -- first_box_id integer not null references boxes (box_id),
  active_box_id integer references boxes (box_id),
  date_sign date,
  date_pub date,
  date_start date,
  date_end date,
...
create table invoices (
  invoice_id primary key generated by default as identity,
  invoice_sf text not null,
...
create table specs (
  ...
  spec_type spec_type_enum not null
  -- qty_proposed numeric,
  -- qty_approved numeric,
  -- qty_consumed numeric
);

create table box_supplies (
  -- box_supply_id integer primary key generated by default as identity,
  spec_id integer not null references specs (spec_id),
  box_id integer not null references boxes (box_id),
  box_qty_initial numeric not null,
  box_price numeric not null,
  bdi numeric not null default 0,
);

create table invoice_supplies (
  -- invoice_supply_id integer primary key generated by default as identity,
  spec_id integer not null references specs (spec_id),
  invoice_id integer not null references boxes (box_id),
  invoice_qty_initial numeric not null,
...
create table labor (
  labor_id integer primary key generated by default as identity,
  spec_id integer not null references specs (spec_id),
  box_id integer not null references boxes (box_id),
...
create table allocations (
  ...
  -- qty approval
  qty_approved numeric,
  -- finish task and/or bind alloc to a purchase
  qty_consumed numeric,
  invoice_id integer references boxes (box_id),
  purchase_id integer references purchases (purchase_id),
  -- choose alloc price from (1) box, (2) invoice or (3) search
