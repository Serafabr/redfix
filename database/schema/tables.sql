...
create table allocations (
  ...
  allocated_by integer not null references persons (person_id) default get_person_id(),
  -- proposal
...
create table invoices (
  ...
  invoice_sf text,
  depot_id integer not null references boxes (box_id),
...
create table refunds (
  ...
  -- timestamp DATETIME,
  -- mesref DATE,
  billing_id not null references billings (billing_id),  
  -- chavenfe VARCHAR(100),
  -- itemnfestr VARCHAR,
  invoice_item_id not null references invoice_items (invoice_item_id),
  -- fconv VARCHAR(100),
  conversion_factor numeric not null default 1,
  -- observacao VARCHAR,
  note text,
