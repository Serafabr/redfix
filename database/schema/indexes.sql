...
create index on specs (depot_id);
...
create index on task_supplies (task_id);
create index on task_supplies (spec_id);
create index on task_supplies (internal_box_id);
create index on task_supplies (external_box_id);
create index on task_supplies (supply_id);
create index on task_supplies (invoice_id);
